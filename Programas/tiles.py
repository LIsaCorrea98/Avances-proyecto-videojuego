        ...
        for row in map:
            ...
            for tile in row:
                if tile == '6':
                    ...
                    tiles.append(Tile('barandaFinalAbajo.png', x * self.tile_size, y * self.tile_size, self.spritesheet))
                elif tile == '9':
                    tiles.append(Tile('barandaFinalArriba.png', x * self.tile_size, y * self.tile_size, self.spritesheet))
                elif tile == '10':
